...
const HomePage: React.FC<HomePageProps> = () => {
  return (
    <>
      ...
      <h1 className='p-4 mt-14 mx-auto w-full text-center'>Standard Directive Number 2</h1>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid max-w-3xl gap-6 mx-auto lg:gap-12 lg:max-w-5xl lg:grid-cols-2 lg:items-center lg:grid-flow-col lg:gap-12">
            ...
            <div className=" gap-4 min-[400px]  overflow-hidden rounded-s border-gray-800 card">
              <iframe className='rounded-s' width="580" height="315" src="https://www.youtube.com/embed/lqMthruPavU?si=WOS4whMaHMZuzjGc&amp;clip=UgkxOZYzF4_l3c61N5upjo5t82d7EXlwVx3r&amp;clipt=EIDoBxiR7Ak" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
          </div>
        </div>
      </section>

      <section className="w-full py-12 md:py-24 lg:py-32 px-60">
        <div className="container px-4 md:px-6">
          <div className="grid max-w-3xl gap-6 mx-auto lg:gap-12 lg:max-w-5xl lg:grid-cols-1 lg:items-center lg:grid-flow-col ">
            <div className="space-y-4 ">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-600">
      ...
      <footer className="p-4 bg-gray-200 text-center">
        <p>Planning and discipline are the bedrock of success. Start your journey today with our comprehensive calendar tool.</p>
      </footer>
    </>
  );
};
